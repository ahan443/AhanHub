...
const AboutPage: React.FC = () => {
    return (
        <div className="animate-fade-in max-w-4xl mx-auto text-gray-300">
            <div className="bg-slate-800/50 p-6 sm:p-8 rounded-lg border border-slate-700 shadow-lg shadow-cyan-900/10">
                <h2 className="text-3xl font-bold mb-4 text-cyan-400">About AhanHub</h2>
